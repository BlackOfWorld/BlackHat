...
public abstract class TinyProtocol {
    ...
    private static final Method getPlayerHandle = ReflectionUtils.getMethod("{obc}.entity.CraftPlayer", "getHandle");
    private static final Field getConnection = ReflectionUtils.getField("{nms}.EntityPlayer", "playerConnection");
    private static final Field getManager = ReflectionUtils.getField("{nms}.PlayerConnection", "networkManager");
    private static final Field getChannel = ReflectionUtils.getField("{nms}.NetworkManager", Channel.class, 0);
    ...
    private static final Field getGameProfile = ReflectionUtils.getField(PACKET_LOGIN_IN_START, GameProfile.class, 0);
